...
public class BrowserActivity extends Activity implements BrowserController {
	...
	private synchronized void initialize() {
		...
		mSearch.setOnFocusChangeListener(new View.OnFocusChangeListener() {
			...
			public void onFocusChange(View v, boolean hasFocus) {
				if (!hasFocus && mCurrentView != null) {
					if (mCurrentView != null) {
						if (mCurrentView.getProgress() < 50) {
							setIsLoading();
						} else {
							setIsFinishedLoading();
						}
		...
		mSearch.setOnKeyListener(new OnKeyListener() {
			...
			@Override
			public boolean onKey(View arg0, int arg1, KeyEvent arg3) {
	...
	public void initializeTor() {
		...
		try {
			...
			WebkitProxy.setProxy("com.browser.popbrowser.BrowserApp", getApplicationContext(), host,
					port);
		} catch (Exception e) {
	...
	public synchronized void initializePreferences() {
		...
		if (mPreferences.getBoolean(PreferenceConstants.USE_PROXY, false)) {
			...
			try {
				WebkitProxy.resetProxy("com.browser.popBrowser.BrowserApp", getApplicationContext());
			} catch (Exception e) {
	...
	static class FullscreenHolder extends FrameLayout {
		...
		public FullscreenHolder(Context ctx) {
			super(ctx);
			setBackgroundColor(ctx.getResources().getColor(android.R.color.darker_gray));
		}
